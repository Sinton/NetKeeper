 ...
 * @author Yan
 */
public class VueAnyXmlElementDescriptor extends AnyXmlElementDescriptor implements XmlElementDescriptor {
    private final String name;

    public VueAnyXmlElementDescriptor(XmlElementDescriptor xmlElementDescriptor, XmlNSDescriptor xmlNSDescriptor, String name) {
