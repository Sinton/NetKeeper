 ...
 * @author sjl
 */
public class VueTagNameProvider implements XmlElementDescriptorProvider, XmlTagNameProvider {
    ...
    public XmlElementDescriptor getDescriptor(XmlTag xmlTag) {
        ...
        return new VueAnyXmlElementDescriptor(descriptor, nsDescriptor, xmlTag.getName());
    }
}
