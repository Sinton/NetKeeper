 ...
 * @author sjl
 */
public class VueAttributeDescriptor extends BasicXmlAttributeDescriptor implements XmlAttributeDescriptorEx, PsiPresentableMetaData {
    protected final Project project;
    private final String attributeName;
    private String[] attributeValues = null;

    public VueAttributeDescriptor(final Project project, String attributeName, String[] attributeValues) {
